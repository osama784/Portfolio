...
const projectsSectionHeading =
  projectsSection.querySelector("#section-heading") as HTMLElement;
const otherProjectsSectionHeading =
  otherProjectsSection.querySelector("#section-heading") as HTMLElement;
...
const homeSectionHeadingDescription =
  homeSectionHeading.querySelector("#description") as HTMLElement;
